...
// include: C:\Users\conne\AppData\Local\Temp\tmpu6qn0yne.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'D:/Projects/Ancient/html/Ancient.data';
      var REMOTE_PACKAGE_BASE = 'Ancient.data';
...
Module['FS_createPath']("/resources", "html", true, true);
Module['FS_createPath']("/resources", "placeholder", true, true);
Module['FS_createPath']("/resources/placeholder", "kenney", true, true);
Module['FS_createPath']("/resources", "shaders", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_D:/Projects/Ancient/html/Ancient.data');

      };
      Module['addRunDependency']('datafile_D:/Projects/Ancient/html/Ancient.data');
    ...
    loadPackage({"files": [{"filename": "/resources/campfire.png", "start": 0, "end": 306}, {"filename": "/resources/cc-29-8x.png", "start": 306, "end": 567}, {"filename": "/resources/flag.png", "start": 567, "end": 830}, {"filename": "/resources/fonts/BrassMono-Regular.ttf", "start": 830, "end": 42634}, {"filename": "/resources/fonts/FuzzyBubbles-Bold.ttf", "start": 42634, "end": 182162}, {"filename": "/resources/fonts/FuzzyBubbles-Regular.ttf", "start": 182162, "end": 327170}, {"filename": "/resources/fonts/m5x7.ttf", "start": 327170, "end": 361470}, {"filename": "/resources/html/Ancient.html", "start": 361470, "end": 362362}, {"filename": "/resources/placeholder/kenney/License.txt", "start": 362362, "end": 362931}, {"filename": "/resources/placeholder/kenney/Tilesheet.txt", "start": 362931, "end": 363170}, {"filename": "/resources/placeholder/kenney/atlas.png", "start": 363170, "end": 386776}, {"filename": "/resources/placeholder/kenney/blue_guy.png", "start": 386776, "end": 387170}, {"filename": "/resources/player.png", "start": 387170, "end": 387597}, {"filename": "/resources/shaders/FadeShader.fs", "start": 387597, "end": 388220}, {"filename": "/resources/world.json", "start": 388220, "end": 389316}], "remote_package_size": 389316});

  })();

// end include: C:\Users\conne\AppData\Local\Temp\tmpu6qn0yne.js
// include: C:\Users\conne\AppData\Local\Temp\tmpx2om74hq.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\conne\AppData\Local\Temp\tmpx2om74hq.js
// include: C:\Users\conne\AppData\Local\Temp\tmp_vj9rwd6.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\conne\AppData\Local\Temp\tmp_vj9rwd6.js
...
var ASM_CONSTS = {
  5293156: () => { if (document.fullscreenElement) return 1; },  
 5293202: () => { return document.getElementById('canvas').width; },  
 5293254: () => { return parseInt(document.getElementById('canvas').style.width); },  
 5293322: () => { document.exitFullscreen(); },  
 5293349: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 5293422: () => { if (document.fullscreenElement) return 1; },  
 5293468: () => { return document.getElementById('canvas').width; },  
 5293520: () => { return screen.width; },  
 5293545: () => { document.exitFullscreen(); },  
 5293572: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 5293705: () => { return window.innerWidth; },  
 5293731: () => { return window.innerHeight; },  
 5293758: () => { if (document.fullscreenElement) return 1; },  
 5293804: () => { return document.getElementById('canvas').width; },  
 5293856: () => { return parseInt(document.getElementById('canvas').style.width); },  
 5293924: () => { if (document.fullscreenElement) return 1; },  
 5293970: () => { return document.getElementById('canvas').width; },  
 5294022: () => { return screen.width; },  
 5294047: () => { return window.innerWidth; },  
 5294073: () => { return window.innerHeight; },  
 5294100: () => { if (document.fullscreenElement) return 1; },  
 5294146: () => { return document.getElementById('canvas').width; },  
 5294198: () => { return screen.width; },  
 5294223: () => { document.exitFullscreen(); },  
 5294250: () => { if (document.fullscreenElement) return 1; },  
 5294296: () => { return document.getElementById('canvas').width; },  
 5294348: () => { return parseInt(document.getElementById('canvas').style.width); },  
 5294416: () => { document.exitFullscreen(); },  
 5294443: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 5294501: () => { return screen.width; },  
 5294526: () => { return screen.height; },  
 5294552: () => { return window.screenX; },  
 5294579: () => { return window.screenY; },  
 5294606: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 5294659: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 5294730: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 5294787: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 5295043: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 5295114: () => { if (document.fullscreenElement) return 1; },  
 5295160: () => { return window.innerWidth; },  
 5295186: () => { return window.innerHeight; },  
 5295213: () => { if (document.pointerLockElement) return 1; }
};
